...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://udaykiran.net/" },
      { property: "og:image", content: "https://udaykiran.net/udaykiran-pottabathula.png" },
      { name: "twitter:title", content: "Udaykiran Pottabathula — AI Product Manager" },
      { name: "twitter:description", content: "Transforming business challenges into AI-powered product solutions." },
      { name: "twitter:image", content: "https://udaykiran.net/udaykiran-pottabathula.png" },
    ],
    links: [{ rel: "canonical", href: "https://udaykiran.net/" }],
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "Person",
          name: "Udaykiran Pottabathula",
          jobTitle: "AI Product Manager & Product Owner",
          url: "https://udaykiran.net/",
          image: "https://udaykiran.net/udaykiran-pottabathula.png",
          sameAs: [
            "https://www.linkedin.com/in/udaykiranpottabathula/",
            "https://github.com/udaykir005",
          ],
        }),
      },
      {
        ...
        children: JSON.stringify({
          ...
          name: "Udaykiran Pottabathula",
          url: "https://udaykiran.net/",
          description: "Portfolio of Udaykiran Pottabathula — AI Product Manager building AI-powered product solutions.",
        }),
      },
    ],
  }),
